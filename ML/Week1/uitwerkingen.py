...
def gradientDescent(X, y, theta, alpha, num_iters):
    ...
    # De algemene structuur van de code is al gegeven (feitelijk een dubbele for-lus: de eerste
    # lus is het aantal iteraties en de binnenste lus betreft het aantal parameters van theta).
    # In de code is een _ gebruikt om een variabele aan te duiden waar we verder niet in zijn
    # geïnteresseerd.
...
def contourPlot(X, y):
    ...
    # zetten. Deze ndarray kun je vervolgens meesturen aan computeCost. Bedenk of je nog een
